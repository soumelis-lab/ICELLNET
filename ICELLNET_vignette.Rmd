...
<center>
![](ICELLNET_Figure2_v8.png){width=700px}
</center>
...
#Target central cell file (description of the different samples)
CC.target = as.data.frame(read.table("~/Desktop/Labo/Work Desktop/ICELLNET/Projects/CAF/Data/target_CAF.txt",sep = "\t",header=T))
head(CC.target)
```
