#'
#' ligand.average.RNAseq function
#'
#' @description Compute the average expression for all ligands expressed in dataset provided, only available for RNA-seq dataset with gene symbol annotation.
#'
